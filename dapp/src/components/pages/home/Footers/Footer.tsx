          ...
          >
            <Stack display={{ base: 'none', lg: 'block' }}>
              <Link as={ReachLink} to="/">
                <PMsvgIcon width="60" height="60" viewBox="0 0 60 60" />
              </Link>
            </Stack>
            <Stack>
              <ListHeader>Services</ListHeader>
              <Link as={ReachLink} to="/register" fontSize={'14px'}>
                Register
              </Link>
            ...
            <Stack>
              ...
              <Link
                as={ReachLink}
                to="/identity/3/0xbEc6F6B37CFF8355a046afD2a2EcfEA05c1215F5"
                fontSize={'14px'}
              >
                About Me
              </Link>
        ...
        >
          <Stack direction={{ base: 'row', md: 'row' }}>
            ...
            >
              ...
              by The PaperMasters ~ working to bring protection and legitimacy
              to the Blockchain.
            </Text>
            <Spacer />
            <Grid
            ...
            >
              <SocialButton
                label={'Twitter'}
                href={'https://twitter.com/ramonajenny_n'}
              >
                <FaTwitter />
              </SocialButton>
