...
import {postMentionInterface, usePostMentionMutation} from "../../../../features/reactQuery/RTKQuery";
...
export const MentionsDrawer:FC<interfaceMentionsDrawer>=({chainIdURL, paramsWalletURL, mentionsFullDisplayWindowBool, isOpenOpen, onCloseClose, onOpenOpen})=> {
        ...
        >
            ...
            <DrawerContent>
                ...
                <DrawerBody>
                    ...
                    >
                        ...
                        >
                            ...
                            <Stack spacing='24px'>
                                {accountArrArr.length !== 0 && accountArrArr[0] !== paramsWalletURL ?
                                    <Box
                                        flex={'max-content'}
                                        mt={'18px'}
                ...
                <DrawerFooter borderTopWidth='1px'>
                    ...
                    {accountArrArr.length !== 0 && paramsWalletURL !== accountArrArr[0] ?
                        <Button
                            color='pmpurple.12'
                            border={'1px solid'}
                            borderColor={'pmpurple.6'}
