  ...
  const columns: Column<Cols>[] = useMemo(
    () => [
      ...
      },
      {
        Header: (
          <Center>
            <Text style={{ whiteSpace: 'nowrap' }}> Validations </Text>
          </Center>
        ),
      ...
      },
      {
        Header: (
          <Center>
            <Text style={{ whiteSpace: 'nowrap' }}> Validate </Text>
          </Center>
        ),
        accessor: 'validate',
        Cell: (el) => {
          return (
            <Center>
              <Button
                as={ReachLink}
                to={`/validate/${el.row.original.chainId}/${el.row.original.wallet}`}
                color={'pmpurple.13'}
                bg={'#f2eef2'}
                fontSize={'12px'}
              >
                <MdOutlineLibraryAddCheck fontSize={'16px'} />
                <Text fontSize={'12px'} ml={'6px'}>
                  {' '}
                  Validate{' '}
                </Text>
              </Button>
      ...
      },
      {
        Header: (
          <Center>
            <Text style={{ whiteSpace: 'nowrap' }}> Reported </Text>
          </Center>
        ),
        accessor: 'reported',
      },
      {
        Header: (
          <Center>
            <Text style={{ whiteSpace: 'nowrap' }}> Report </Text>
          </Center>
        ),
        accessor: 'report',
        Cell: (el) => {
          return (
            <Center>
              <Button
                as={ReachLink}
                to={`/report/${el.row.original.chainId}/${el.row.original.wallet}`}
                color={'pmpurple.13'}
                bg={'#f2eef2'}
                fontSize={'12px'}
              >
