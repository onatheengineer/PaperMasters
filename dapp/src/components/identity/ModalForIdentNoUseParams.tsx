...
export const ModalForIdentNoUseParams:FC=()=> {
    ...
    return (
        ...
        <Modal finalFocusRef={finalRef} isOpen={true} onClose={onClose} blockScrollOnMount={true}>
            <ModalOverlay/>
            <ModalContent>
                <ModalHeader fontSize={'24px'} fontWeight='bold' color={"pmpurple.13"} >Connect Wallet Account</ModalHeader>
                <ModalBody>
                ...
                <ModalFooter>
                    ...
                    <Button as={ReachLink} to='/search' bg={'pmpurple.5'} color={"pmpurple.13"} border={'1px solid'} borderColor={'pmpurple.8'}>Go to Search Page</Button>
                </ModalFooter>
            </ModalContent>
        </Modal>
        </>
