...
const ContractFunctionsSlice = createSlice( {
    name: 'functions',
    initialState,
    reducers: {
...
export const { supportDeposit, NFIMintFee } = ContractFunctionsSlice.actions;
...
export default ContractFunctionsSlice.reducer;